    ...
    */
    ...
    'mailers' => [
        ...
        'smtp' => [
            ...
            // MAIL_VERIFY_PEER=false avoids "certificate verify failed" when server CA bundle is missing or SMTP cert can't be verified. Set true + MAIL_CAFILE for strict verification.
            ...
            'stream' => [
                ...
                ] + (filter_var(env('MAIL_VERIFY_PEER', 'false'), FILTER_VALIDATE_BOOLEAN) && env('MAIL_CAFILE')
